...
const CUSTOM_TRIGGERS = [
  {
  triggers: ["Иди нахуй", "Нахуй сходи"],
  reply: "Тебе помочь чем-то? Я просто бот меня не програмировали идти на то самое место! Но 7ewer за 320 юси добавит в меня эту функцию!!!",
},
  {
...
{
  triggers: ["Пошел нахуй", "Даун?"],
  reply: "Ты когда-то собирал зубы сломанными пальцами?",
},
...
const DESCRIPTION_TEMPLATE =
  "📄 Это шаблон описания, его нужно сначало отправить в этот чат для проверки, если все правильно то после получения ссылки для вступления в группу отправь описание в основной чат:\n\n" +
  "+Описание\n" +
  "Имя: Паша, Паштет\n" +
  "Ник: dm Nemezz\n" +
  "Айди: 52044684830\n" +
