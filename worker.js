...
const DESCRIPTION_TEMPLATE =
  "📄 Это шаблон описания, его нужно санчало отправить в этот чат для проверки, если все правильно то после получения ссылки для встпления в группу отправь описание в основной:\n\n" +
  "+Описание\n" +
  "Имя: Паша, Паштет\n" +
  "Ник: dm Nemezz\n" +
  "Айди: 52044684830\n" +
